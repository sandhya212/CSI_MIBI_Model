...
#}else{
    ...
    mu_final <- results.all.MCMC[[num_gene_batches]][[num_gene_sub_batches]][[2]]; #numgenes x K (c1,c2..)
    Sigma_final <- results.all.MCMC[[num_gene_batches]][[num_gene_sub_batches]][[3]]; #numgenes x numgenes X K (c1,c2..)
